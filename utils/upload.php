...
function upload_files() {
    ...
    ////////////////////////////////////////////////////////////////////////////
    $upfile = $_SERVER['DOCUMENT_ROOT'].'/www/EDEN/media/'.$_FILES['file']['name'];//Cambiado avatar por file
    if (is_uploaded_file($_FILES['file']['tmp_name'])){
        if (is_file($_FILES['file']['tmp_name'])) {
            ...
            $upfile = $_SERVER['DOCUMENT_ROOT']."/www/EDEN/media/".$nombreFichero;
        }else{
                $error .=   "Invalid File...";
        }
    }
...
function remove_files(){
  ...
  //exit;
	if(file_exists($_SERVER['DOCUMENT_ROOT'].'/www/EDEN/media/'.$_SESSION['nombreFichero'])){
		unlink($_SERVER['DOCUMENT_ROOT'].'/www/EDEN/media/'.$_SESSION['nombreFichero']);
		return true;
	}else{
		return false;
	}
